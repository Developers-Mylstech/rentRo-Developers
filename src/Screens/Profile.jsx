...
function Profile() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 pb-10">
                ...
                {orders.map(order => (
                  ...
                  >
                    <div className="flex justify-between items-center">
                      ...
                      <div className="text-right">
                        <p className="font-bold">AED {order.total.toFixed(2)}</p>
                        <span className={`px-2 py-1 text-xs rounded-full ${
                          order.status === 'Delivered' ? 'bg-green-100 text-green-800' : 
                    ...
                    <div className="mt-2">
                      {order.orderDetails.cart.items.map(item => (
                        <div key={item.cartItemId} className="flex items-center mt-2">
                          <img 
                          ...
                          <div className="ml-2">
                            ...
                            <p className="text-xs text-gray-500">AED {item.price.toFixed(2)}</p>
                          </div>
                        </div>
                      ))}
                    </div>
      ...
      {/* Rest of your existing dialogs */}
      {/* ... (keep the existing address and payment dialogs unchanged) ... */}
    </div>
  );
}
