...
const jobs = [
  ...
  },
  {
    ...
    description: "Design and implement scalable APIs and microservices using Node.js and Python for our growing platform.",
    salary: "Not Disclosed",
    location: "Remote",
    openings: 2,
    type: "Full-time",
  ...
  },
  {
    id: 3,
    title: "UX Designer",
    description: "Create intuitive user experiences and interfaces. Portfolio demonstrating user-centered design required.",
    salary: "Not Disclosed",
    location: "Remote",
    openings: 1,
    type: "Contract",
  ...
  },
  {
    ...
    description: "Implement CI/CD pipelines and manage cloud infrastructure on AWS with Kubernetes and Terraform.",
  ...
  return (
    <section className='max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8'>
      ...
      <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-1">
        {jobs.map((job) => (
          <div key={job.id} className="bg-white rounded-xl shadow-lg overflow-hidden border border-gray-100 hover:shadow-xl transition-all duration-300">
            <div className="p-6 sm:p-8">
              <div className="flex flex-col sm:flex-row">
                ...
                <div className="flex-1">
                  <div className="flex flex-col md:flex-row md:justify-between md:items-start">
                    ...
                    <span className="inline-flex items-center px-3 py-1 rounded-full text-sm font-medium bg-blue-100 text-blue-800 mb-4 md:mb-0">
                      {job.type}
                    </span>
                  </div>
              ...
              <div className="mt-6 flex justify-end">
                <button 
                  onClick={() => navigate(`/career/${job.title}`,)}
