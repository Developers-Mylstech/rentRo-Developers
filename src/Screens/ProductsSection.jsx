...
const products = [
  { id: 1, name: "Domestic Water Filter", price: "AED50.00", image: img1, rating: 3.5 },
  { id: 2, name: "Commercial Water Filter", price: "AED100.00", image: img2, rating: 4 },
  { id: 3, name: "Industrial Water Filter", price: "AED50.00", image: img3, rating: 4.5 },
...
const ProductsSection = () => {
  return (
    <div className="mx-auto py-8 px-4">
      {/* Products On Rent */}
      <h2 className="text-center text-xl font-semibold text-gray-700">Just For You</h2>
      <h1 className="text-center text-2xl font-bold my-4">Products On Monthly Rent</h1>
      ...
      >
        {products.map((product) => (
          <SwiperSlide key={product.id} className="p-4 border rounded-lg shadow hover:shadow-lg transition">
      ...
      <h2 className="text-center text-xl font-semibold text-gray-700 mt-10">Just For You</h2>
