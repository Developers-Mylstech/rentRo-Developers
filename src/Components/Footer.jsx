...
//   } from-[#0a448b] to-[#0e86bdcf] text-gray-300 py-12 px-6 md:px-8 border-t`}
// >
//   <div className="max-w-screen-xl w-full mx-auto grid grid-cols-1 md:grid-cols-6 gap-8 md:8 z-10">
//     {/* Company Info */}
...
//   } from-[#0a448b] to-[#0e86bdcf] text-gray-300 py-12 px-6 md:px-8 border-t`}
// >
//   <div className="max-w-screen-xl w-full mx-auto flex justify-between  gap-8 md:gap-12 z-10">
//     {/* Company Info */}
//     <div className="w-[20%]">
//       <img
//         src={rentroLogo}
