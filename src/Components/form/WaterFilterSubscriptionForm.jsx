...
const WaterFilterSubscriptionForm = () => {
  ...
  const onSubmit = (data) => {
    const payload = {
      cartId: cartItems.cartId, // Default value as per API
      ...
      paymentOption: data.paymentMethod?.toUpperCase().replace(/ /g, "_") || "CREDIT_CARD",
      ...
      //   filtersPerMonth: parseInt(data.filtersPerMonth) || 1,
      //   billingContact: data.billingContact,
      //   billingEmail: data.billingEmail,
      //   billingAddress: data.billingAddress
      // }),
      // Additional fields for individual type
      // ...(type === "individual" && {
      //   deliveryDays: data.deliveryDays // Array of selected days
      // })
    };
          ...
          <>
            ...
            <Section title="Payment Information">
              <Select
                label="Payment Method"
                name="paymentMethod"
                options={["Credit Card", "Mobile Payment", "Bank Transfer"]}
                required
              />
              <Input label="Billing Address (if different)" name="billingAddress" />
            </Section>
