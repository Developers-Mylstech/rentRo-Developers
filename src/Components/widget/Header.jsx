...
//                  >
//                    <FiUser className="text-xl" />
//                    <span className="text-sm">Hi👋🏻 <span className="hidden md:inline">{user?.name || 'User'}</span></span>
//                  </button>
//                </div>
//                )}
...
//           {/* Cart Button */}
//           <button className="text-[11px] md:text-xs flex items-center bg-gradient-to-r from-[#00d2ff] to-[#3a7bd5] text-white md:px-6 md:py-3 px-2 py-2 md:rounded-full rounded-md gap-1 border border-white hover:shadow-lg transition-all">
//             <FaShoppingCart className="text-base" />
//             AED 0.00
//           </button>
//           </div> 
