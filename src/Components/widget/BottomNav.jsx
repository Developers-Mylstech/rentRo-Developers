...
const BottomNav = () => {
  ...
  const sidebarItems = [
    { path: "/domesticservice", label: "Domestic Services" },
    { path: "/commercialservice", label: "Commercial Service" },
    { path: "/industrialservice", label: "Industrial Service" },
    { path: "/roservices", label: "RO Service" }
  ];
  ...
  return (
    <>
      ...
      {/* Bottom Navigation */}
      <nav className="md:hidden fixed left-0 bottom-0 w-full bg-white shadow-md border-t border-gray-200 z-50 rounded-t-lg">
        <ul className="flex justify-around items-center text-gray-500 py-2">
